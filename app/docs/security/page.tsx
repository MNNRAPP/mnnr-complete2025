...
const securityMetrics = [
  { label: 'Target Availability', value: '99.9%+', icon: '⏱️' },
  { label: 'Encryption', value: 'AES-256', icon: '🔒' },
  { label: 'TLS Version', value: '1.3', icon: '🌐' },
  { label: 'Security Focus', value: 'High', icon: '✅' },
];
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 relative">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Protecting the machine economy with bank-level encryption, security best practices, 
          ...
          <div className="relative bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-2xl p-8 text-center overflow-hidden mb-16">
            ...
            <div className="relative">
              ...
              <h3 className="text-3xl font-bold text-white mb-2">
                Our Security <span className="text-green-400">Commitment</span>
              </h3>
              <p className="text-gray-400 max-w-xl mx-auto mb-6">
                We implement industry best practices and continuously improve our security posture 
